...
class TestLidlReceipts(unittest.TestCase):

    def test_function_all(self):
        expected_df_1 = pd.DataFrame({
        "Položka": ["Sušenky s krémem_Lidl", "Mrkev volná_Lidl", "Hrozny tmave 500g_Lidl"],
        ...
        "Položka": ["Kaiserka cer.XXxL_Lidl", "Kaiserka cer.XXxL_Lidl", "Kaiserka cer.XXxL_Lidl", "Kaiserka cer.XXxL_Lidl", "Kaiserka cer.XXxL_Lidl",
            "Eidam plátky_Lidl", "Eidam plátky_Lidl", "Sušenky s krémem_Lidl", "Kuř.steaky Piri P._Lidl", "Hrozny bílé 500gBS_Lidl"],
        ...
        "Položka": ["Ementál plátk. sýr_Lidl", "Čers.mléko 1,5% 11_Lidl", "Sušenky s krémem_Lidl", "Rajčata keříková_Lidl", 
            "Kornbageta_Lidl", "Kornbageta_Lidl", "Kornbageta_Lidl", "Paprika červená_Lidl"],
