...
class TestAlbertReceipts(unittest.TestCase):
    ...
    def test_function_all(self):
        ...
        #test1 - item with 0% dph
        #test2 - item with 12% dph
        #test3 - item with 21% dph removed
        #test5 - receipt with only 1 item
        #test6 - receipt with proportional size = 1 and proportional size < 1 
        #test7 - "kreditů" and "kredity" properly removed
